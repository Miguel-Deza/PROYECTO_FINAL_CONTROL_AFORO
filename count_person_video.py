...
while (video.isOpened()):
    ...
    # Variable to count people in the current frame
    person_count = 0
    ...
    # Add the person count of the current frame to the total person count
    ...
    # cv2.putText(frame, 'Total persons: {}'.format(total_person_count), (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
...
# print('Total number of persons detected:', total_person_count)
